...
public class EnemyBullet_sniper {
    ...
    public EnemyBullet_sniper(AssetManager assetManager, float width, float height, float Boffset_x, float Boffset_y, float Bspread, boolean easterEgg) {
        ...
        if(easterEgg) {
            ...
            bullet = new Sprite((Texture) assetManager.get("pew.png"));
        }
