...
import com.deo.flapd.utils.postprocessing.utils.FullscreenQuad;
...
public abstract class Filter<T> {
    ...
    protected void setParam(Vector3 value) {
        program.bind();
        program.setUniformf(((Parameter) CrtScreen.Param.Tint).mnemonic(), value);
    }
    ...
    // vec3 version
    protected T setParams(Vector3 value) {
        if (!programBegan) {
            programBegan = true;
            program.bind();
        }
